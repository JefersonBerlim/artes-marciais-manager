...
<head>
    ...
    <title>Consulta de Graduações</title>

    <script>
    
        function Deleta(  ) { 
        
            if( confirm('Confirma a exclusão da Graduação')){
                return true;
...
<body>
    ...
    <table cellspacing="0" summary="Tabela de dados fictícios">'
        ...
        <tbody>
            ...
            <script>
                jAlert('Problemas ao Excluir a Graduação: ${entidade.graDescricao}' ,'Atenção');
            </script>
