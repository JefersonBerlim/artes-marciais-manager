...
<html>
    ...
    <body>
        ...
        <c:set var="query" >
            ...
            WHERE
            1=1
            AND (  TB_PAGAMENTOS."PAG_VALORPAGO" - ( TB_MENSALIDADE."MEN_VALOR" - ( ( TB_MENSALIDADE."MEN_VALOR" / 100) * TB_ALUNO."ALU_DESCONTO") ) ) < 0
        </c:set>
        ...
        <c:url value="GeraRelatoriosFiltro.jsp" var="relatorio">
            <c:param name="reportName" value="Relatorios/MensalidadesEmAberto.jasper"/>
